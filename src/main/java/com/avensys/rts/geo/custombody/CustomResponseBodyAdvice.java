package com.avensys.rts.geo.custombody;
...
import com.avensys.rts.geo.customresponse.HttpResponse;
...
public class CustomResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(
        ...
        try {
            ...
            Long startTime = (Long) ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest().getAttribute("in");
